        ...
        {messagesWithDividers.map((item) => {
          ...
          return (
            ...
            >
              ...
              >
                {message.role === "assistant" ? (
                  <div className="text-sm prose prose-invert prose-sm max-w-none prose-p:my-4 prose-ul:my-2 prose-li:my-0 prose-strong:text-white prose-strong:block prose-strong:mt-4">
