  ...
  <tr>
    <td align="center" style="padding: 40px 20px;">
      <table width="480" cellpadding="0" cellspacing="0" style="background-color: #141414; border-radius: 16px;">
        <tr>
          <td style="background-color: #7c3aed; padding: 32px 24px; text-align: center; border-radius: 16px 16px 0 0;">
            <span style="font-size: 28px; font-weight: 800; color: #ffffff; text-transform: uppercase; letter-spacing: -0.5px;">NETGAINS</span>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding: 24px 32px; border-top: 1px solid #27272a;">
            <p style="margin: 0; font-size: 14px; color: #71717a;">— The NetGains Team</p>
          </td>
        </tr>
      </table>
    </td>
      ...
      <table width="480" cellpadding="0" cellspacing="0" style="background-color: #141414; border-radius: 16px;">
        ...
        <tr>
          <td style="padding: 40px 32px;">
            ...
            <p style="margin: 0 0 8px 0; font-size: 16px; color: #a1a1aa;">1. Go to <a href="https://netgainsai.com" style="color: #a78bfa;">netgainsai.com</a></p>
        ...
        <tr>
          <td style="padding: 24px 32px; border-top: 1px solid #27272a;">
            <p style="margin: 0; font-size: 14px; color: #71717a;">Questions? Just reply to this email.<br/>— The NetGains Team</p>
          </td>
        </tr>
      </table>
    </td>
